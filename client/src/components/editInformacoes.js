        ...
        return(
            <div style={BACKGROUND_STYLE}>
                <div className="mt-7 m-5 sm:mx-auto sm:w-full sm:max-w-lg bg-white p-5 rounded-lg" style={MODAL_STYLE}>
                    ...
                    <h2 data-aos="zoom-in" data-aos-delay="150" className="mt-2 mb-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">EDITAR INFORMAÇÕES</h2>
                    <form data-aos="zoom-in" data-aos-delay="150" className="flex flex-col" action="submit" onSubmit={handleSubmit(async (data)=>{
                        await axios.post('http://localhost:3333/editInformacoes', {
                            nome: data.nome,
                            sexo: selectedValue,
