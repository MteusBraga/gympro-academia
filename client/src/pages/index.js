    ...
    return (
        <div className={style.body + ' mt-[-22px]'}>
            <header className={style.cabecalho + ' mb-[70px]'}>
                <a data-aos="fade-down" data-aos-delay="200" className={style.cabecalhoIcon}> GYMPRO </a>

                <nav data-aos="fade-down" data-aos-delay="200" className={style.cabecalhoMenu}>
                    ...
                    <a className={style.cabecalhoMenuItem} onClick={() => router.push('/login')}> LOGIN </a>
                </nav>
            ...
            <main className={style.conteudo}>
                <section className={style.conteudoPrincipal + ' w-3/5'}>
                    <div data-aos="fade-right" data-aos-delay="200" className={style.conteudoPrincipalEscrito}>
                ...
                <section data-aos="zoom-in" data-aos-delay="200" className={style.conteudoSecundario}>
                ...
                <section className={style.conteudoTerceiro}>
                    ...
                    <h1 data-aos="fade-down" data-aos-delay="200" className={style.primeiroPlanoTitulo}>BASIC</h1>
                    <div className={style.primeiroPlano}>
                        <div data-aos="fade-down" data-aos-delay="150" className={style.primeiroPlanoConteudo}>
                    ...
                    <h1 data-aos="fade-down" data-aos-delay="200" className={style.segundoPlanoTitulo}>MASTER</h1>
                    <div className={style.segundoPlano}>
                        <div data-aos="fade-down" data-aos-delay="150" className={style.segundoPlanoConteudo}>
                    ...
                    <h1 data-aos="fade-down" data-aos-delay="200" className={style.terceiroPlanoTitulo}>PREMIUM</h1>
                    <div className={style.terceiroPlano}>
                        <div data-aos="fade-down" data-aos-delay="150" className={style.terceiroPlanoConteudo}>
                ...
                <section className={style.conteudoQuarto}>
                    <img data-aos="fade-up-right" data-aos-delay="200" className={style.conteudoQuartoImagem} src="/imagem-quarta.png" />
                    <div data-aos="fade-up-left" data-aos-delay="200" className={style.conteudoQuartoEscrito}>
                ...
                <section className={style.conteudoQuinto}>
                    ...
                    <div className={style.conteudoQuintoSubconteudo}>
                        <div data-aos="zoom-in" data-aos-delay="150" className={style.conteudoQuintoBox}>
                            ...
                            <div className={style.conteudoQuintoPerfil}>
                                ...
                                <div className={style.conteudoQuintoIcons+ ' flex gap-[10px] cursor-pointer'}>
                                    ...
                                    <a href="https://github.com/GislanyDias" target='_blank'>
                                        <svg  className='hover:scale-125 duration-300' width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15 19.7669V16.1729C15.1391 15.0473 14.7799 13.9178 14 13.0281C17 13.0281 20 11.2311 20 8.08637C20.08 6.96325 19.73 5.85809 19 4.94162C19.28 3.90835 19.28 2.83015 19 1.79688C19 1.79688 18 1.79688 16 3.14462C13.36 2.69537 10.64 2.69537 7.99998 3.14462C5.99998 1.79688 4.99998 1.79688 4.99998 1.79688C4.69998 2.83015 4.69998 3.90835 4.99998 4.94162C4.27185 5.8544 3.91845 6.96575 3.99998 8.08637C3.99998 11.2311 6.99998 13.0281 9.99998 13.0281C9.60998 13.4684 9.31998 13.9715 9.14998 14.5106C8.97998 15.0497 8.92998 15.6158 8.99998 16.1729V19.7669" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 16.173C4.49 17.97 4 14.376 2 14.376" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                            ...
                            <div className={style.conteudoQuintoPerfil}>
                                ...
                                <p>MATEUS BRAGA</p>
                                    ...
                                    <a href="https://github.com/mateusbrga" target='_blank'>
                                        <svg  className='hover:scale-125 duration-300' width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15 19.7669V16.1729C15.1391 15.0473 14.7799 13.9178 14 13.0281C17 13.0281 20 11.2311 20 8.08637C20.08 6.96325 19.73 5.85809 19 4.94162C19.28 3.90835 19.28 2.83015 19 1.79688C19 1.79688 18 1.79688 16 3.14462C13.36 2.69537 10.64 2.69537 7.99998 3.14462C5.99998 1.79688 4.99998 1.79688 4.99998 1.79688C4.69998 2.83015 4.69998 3.90835 4.99998 4.94162C4.27185 5.8544 3.91845 6.96575 3.99998 8.08637C3.99998 11.2311 6.99998 13.0281 9.99998 13.0281C9.60998 13.4684 9.31998 13.9715 9.14998 14.5106C8.97998 15.0497 8.92998 15.6158 8.99998 16.1729V19.7669" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 16.173C4.49 17.97 4 14.376 2 14.376" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                            ...
                            <div className={style.conteudoQuintoPerfil}>
                                ...
                                <div className={style.conteudoQuintoIcons + ' flex gap-[10px] cursor-pointer'}>
                                    ...
                                    <a href="https://github.com/wesley1wilson" target='_blank'>
                                        <svg  className='hover:scale-125 duration-300' width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15 19.7669V16.1729C15.1391 15.0473 14.7799 13.9178 14 13.0281C17 13.0281 20 11.2311 20 8.08637C20.08 6.96325 19.73 5.85809 19 4.94162C19.28 3.90835 19.28 2.83015 19 1.79688C19 1.79688 18 1.79688 16 3.14462C13.36 2.69537 10.64 2.69537 7.99998 3.14462C5.99998 1.79688 4.99998 1.79688 4.99998 1.79688C4.69998 2.83015 4.69998 3.90835 4.99998 4.94162C4.27185 5.8544 3.91845 6.96575 3.99998 8.08637C3.99998 11.2311 6.99998 13.0281 9.99998 13.0281C9.60998 13.4684 9.31998 13.9715 9.14998 14.5106C8.97998 15.0497 8.92998 15.6158 8.99998 16.1729V19.7669" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 16.173C4.49 17.97 4 14.376 2 14.376" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                        ...
                        <a data-aos="fade-up" data-aos-delay="150" href="https://github.com/mateusbrga/gympro-academia" target='_blank'>
